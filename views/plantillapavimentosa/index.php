...
/* @var $searchModel app\models\PlantillapavimentosaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Plantillapavimentosas';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div id="w0Pavi" class="x_panel">
  <div class="x_title"><h2><i class="fa fa-table"></i> PLANTILLA DE PAVIMENTOSAS  </h2>
