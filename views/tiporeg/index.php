...
/* @var $searchModel app\models\TiporegSearch */
...
?>
<div  class="x_panel">
  <div class="x_title"><h2><i class="fa fa-table"></i> Tipo de registros  </h2>
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Crear organismo','class'=>'btn btn-default']).
