...
/* @var $searchModel app\models\PlantilladiagnosticopSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Plantilladiagnosticops';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div id="w0diagp" class="x_panel">
  <div class="x_title"><h2><i class="fa fa-table"></i> PLANTILLAS DE DIAGNOSTICOS DE PAPS  </h2>
...
<div class="plantilladiagnosticop-index">
