...
/* @var $searchModel app\models\PlantillafloraSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Plantillafloras';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div id="w0Flora" class="x_panel">
  <div class="x_title"><h2><i class="fa fa-table"></i> PLANTILLA DE FLORA  </h2>
