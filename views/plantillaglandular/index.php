...
/* @var $searchModel app\models\PlantillaglandularSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Plantillaglandulars';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div id="w0gland" class="x_panel">
  <div class="x_title"><h2><i class="fa fa-table"></i> PLANTILLA DE GLANDULAR  </h2>
