...
<div id="w0Prov" class="x_panel">
  <div class="x_title"><h2><i class="fa fa-table"></i> Area  </h2>
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
              ['content'=>
                  ...
                  ['role'=>'modal-remote','title'=> 'Crear area','class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="glyphicon glyphicon-list"></i> Lista de Area',
