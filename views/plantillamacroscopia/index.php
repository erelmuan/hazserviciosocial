...
/* @var $searchModel app\models\PlantillamacroscopiaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Plantilla de macroscopias';
...
<div id="w0p" class="x_panel">
  <div class="x_title"><h2><i class="fa fa-table"></i> PLANTILLAS DE MACROSCOPIAS  </h2>
