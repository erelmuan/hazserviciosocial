...
/* @var $searchModel app\models\PlantillaaspectoSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Plantillaaspectos';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div id="w0Asp" class="x_panel">
  <div class="x_title"><h2><i class="fa fa-table"></i> PLANTILLA DE ASPECTO  </h2>
